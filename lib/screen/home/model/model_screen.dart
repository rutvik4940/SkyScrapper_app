...
class HomeModel
{
  ...
  HomeModel(
      ...
      this.wideModel,
      this.cloudsModel,
      this.sysModel,this.name,this.coordModel});
  factory HomeModel.mapToModel(Map m1)
  {
    List data=m1['weather'];
    List<WeatherModel> datalist=data.map((e) => WeatherModel.mapToModel(e)).toList();
    return HomeModel(base:m1['m1'],visibility:m1['m1'],dt:m1['dt'] ,timezone:m1['m1'],id:m1['id'] ,cod:m1['cod'],weatherlist: datalist,mainModel:MainModel.mapToModel(m1['main']) ,wideModel:WideModel.mapToModel(m1['wind']) ,cloudsModel: CloudsModel.mapToModel(m1['clouds']),sysModel:SysModel.mapToModel(m1['sys']),name: m1['name'],coordModel:CoordModel.mapToModel(m1['coord']));
  }
}
class WeatherModel
{
